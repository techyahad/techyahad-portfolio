...
const BlogCard: React.FC<BlogCardProps> = ({ heading, description, date, category, readTime, blogImage }) => {
  return (
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center space-x-4 text-gray-500 text-sm">
          <div className="flex items-center space-x-2">
            ...
            <span className="bg-gray-200 text-gray-700 py-1 px-2 rounded-full">{category}</span>
          </div>
