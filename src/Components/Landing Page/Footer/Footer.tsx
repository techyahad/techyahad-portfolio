            ...
            <div className=" container mx-auto  lg:mt-20 mt-2 lg:px-0 px-3 ">
                <div className=" flex items-center pb-12  justify-center">
                    <div className="text-center">
                        <h1 className="lg:text-6xl text-2xl   font-medium text-gray-300">
                        ...
                        <p className=" block lg:hidden text-sm   text-gray-400 mt-4">
                            Let's Talk. I'm here to transform your ideas into reality.
                        </p>
                        <button className="  lg:py-3 py-2 mt-10 bg-gray-100 px-6   group relative">
                            <div className='flex items-center gap-1 justify-center text-gray-800'>
                                <span className="lg:block hidden text-lg">Get in touch now</span>
                                <span className="block lg:hidden text-md">Contact Now</span>
