            ...
            <h1 className="block lg:hidden  text-4xl text-gray-800 font-medium mb-6">About me. </h1>
                ...
                <div className=" flex flex-col md:flex-row  lg:mt-24  items-center justify-between">
                    ...
                    <div className="w-full md:w-1/2 mb-8 lg:mb-2">
                        ...
                        <p className="text-lg md:text-xl text-gray-500 md:mb-10 mb-4 ">
                        ...
                        <div className="md:flex cursor-pointer mt-12">
                            <Link to="/about" className="flex items-center justify-center bg-gray-800 text-gray-100 lg:text-gray-100 py-3 lg:over:bg-gray-800 px-6 border-2 font-normal text-xl group relative">
